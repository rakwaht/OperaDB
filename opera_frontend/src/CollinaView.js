...
class CollinaView extends React.Component {
                ...
                return response.json() })   
                    .then( (json) => {
                    	...
                    	(json||[]).forEach(function(obj){ 
				    		if(obj && obj['mensa']==='Mensa Polo Tecnologico'){ 
                    			let week_number = parseInt(obj['week']);
                    			let key = (week_number - firstWeek).toString();
                    			data['polo'][key]['value'] = obj;
				    		}
				    		else if(obj && obj['mensa']==='Mensa Mesiano'){ 
                    			let week_number = parseInt(obj['week']);
                    			let key = (week_number - firstWeek).toString();
                    			data['mesiano'][key]['value'] = obj;
				    		}
				    		else if(obj && obj['mensa']==='Mensa Povo'){ 
                    			let week_number = parseInt(obj['week']);
                    			let key = (week_number - firstWeek).toString();
                    			data['povo'][key]['value'] = obj;
				    		}
						});
        	...
        	toBeRendered = (
			  <div className="row">
			    <div className="col-sm-4">
			    	<SingleCanteen 
			    		canteenName="Mensa Polo Tecnologico"
			    		data={this.state.data['polo']}
			    	/>
			    </div>
			    <div className="col-sm-4">
			    	<SingleCanteen 
			    		canteenName="Mensa Mesiano"
			    		data={this.state.data['mesiano']}
			    	/>
			    </div>
			    <div className="col-sm-4">
			    	<SingleCanteen 
			    		canteenName="Mensa Povo"
			    		data={this.state.data['povo']}
			    	/>
			    </div>
			  </div>
    		);
